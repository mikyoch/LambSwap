            ...
            <Box sx={{ background: "linear-gradient(45deg, rgba(12,38,16,1) 0%, rgba(6,23,11,0.9948354341736695) 20%, rgba(17,38,21,1) 64%, rgba(0,0,0,1) 100%)" }}>
                {tabValue === 2 ?
                    <Box sx={{ background: "linear-gradient(45deg, rgba(12,38,16,1) 0%, rgba(6,23,11,0.9948354341736695) 20%, rgba(17,38,21,1) 64%, rgba(0,0,0,1) 100%)", p: "42px 0 145px" }}>
                        {/* sx={{ m: "0 6px",p: "50px 5.2% 0" }} */}
                        <Container maxWidth="lg">
                            <Paper sx={{ bgcolor: "#232121", borderRadius: "14px", maxWidth: "100%", p: "48px 4.72%", m: "38px 0" }}>
                                <Paper sx={{ bgcolor: "rgba(38, 38, 38, 1)", maxWidth: "100%", borderRadius: "14px", p: "26px 2.2%" }}>
                                    <Grid container justifyContent="space-between">
                                        <Grid xs={12} sm={5}>
                                            ...
                                            <Stack direction="row" justifyContent="space-between" sx={{ padding: "10px 0" }}>
                                                ...
                                                <Input color="primary" placeholder='0.0' type='number' variant="standard" sx={{ color: "white", fontSize: "24px" }}></Input>
                                            </Stack>
                                        ...
                                        <Grid xs={12} sm={5}>
                                            ...
                                            <Stack direction="row" justifyContent="space-between" sx={{ padding: "10px 0" }}>
                                                ...
                                                <Input color="primary" type='number' variant="standard" sx={{ color: "white", fontSize: "24px" }} placeholder='0.0' readOnly></Input>
                                            </Stack>
                                            <Typography align='right' sx={{ fontSize: "16px", color: "#7E8B74" }}>=$ --&nbsp;</Typography>
                                        </Grid>
                                    </Grid>
                            ...
                            <Paper sx={{ bgcolor: "#232121", borderRadius: "14px", p: "2.48%", mt: "145px" }}>
                    ...
                    :
                    <Box sx={{ p: "7.3% " }}>
                        <Paper sx={{ bgcolor: "#232121", p: "26px", borderRadius: "20px", overflow: "auto" }}>
                        ...
                        <Paper sx={{ bgcolor: "#232121", borderRadius: "14px", margin: "68px 0", px: "5%" }}>
                                            ...
                                            <Grid container justifyContent="space-between" sx={{ minWidth: "580px" }}>
                                                <Grid xs={5.5}>
                                                    <Stack direction="row" alignItems="center" justifyContent="space-between">
                                                        ...
                                                        <Stack direction="row" alignItems="center">
                                                            <Input placeholder="0.0" color="primary" type='number' variant="standard" sx={{ color: "white" }}></Input>&nbsp;
