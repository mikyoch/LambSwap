...
contract LambSwapToken is Context, Ownable {
    ...
    /* --------- max tx info --------- */
    uint256 public _maxSupply = 300e9 * 1e9; // maximum supply: 500,000,000,000
    uint256 public _limitTxAmount = 300e9 * 1e9; // transaction limit: 500,000,000,000
    uint256 public numTokensSellToAddToLiquidity = 23e2 * 1e9; // swap token amount: 3900
    ...
    constructor() public {
        ...
        _symbol = "LST";
        _decimals = 9;
        _totalSupply = 23e9 * 1e9; /// initial supply 39,000,000,000
